...
export const CONFIG_PATH = "/home/app/standalone/shared";
export const PROCESSING_PATH = "/home/app/standalone/shared/.processing";
export const TIDAL_API_URL = "https://api.tidal.com";
export const SYNC_DEFAULT_CRON = "0 3 * * *";
export const TOKEN_REFRESH_THRESHOLD = 60 * 60; // Refresh token if expires in less than 30 minutes (1800 seconds)
